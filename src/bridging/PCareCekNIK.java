 ...
 * @author dosen
 */
public final class PCareCekNIK extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public PCareCekNIK(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            public void windowClosed(WindowEvent e) {
                if(pasien.getTable().getSelectedRow()!= -1){                   
                    if(pasien.getTable().getValueAt(pasien.getTable().getSelectedRow(),3).toString().equals("")){
                        ...
                        NoNIK.setText(pasien.getTable().getValueAt(pasien.getTable().getSelectedRow(),3).toString());
                    }                     
                }  
                if(pasien.getTable2().getSelectedRow()!= -1){ 
                    if(pasien.getTable2().getValueAt(pasien.getTable2().getSelectedRow(),3).toString().equals("")){
                        ...
                        NoNIK.setText(pasien.getTable2().getValueAt(pasien.getTable2().getSelectedRow(),3).toString());
                    } 
                }
                if(pasien.getTable3().getSelectedRow()!= -1){ 
                    if(pasien.getTable3().getValueAt(pasien.getTable3().getSelectedRow(),3).toString().equals("")){
                        ...
                        NoNIK.setText(pasien.getTable3().getValueAt(pasien.getTable3().getSelectedRow(),3).toString());
                    } 
                }                        
            }
            @Override
        ...
        isForm();
        NoNIK.setDocument(new batasInput((int)80).getKata(NoNIK));
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2024" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Peserta PCare Berdasarkan NIK ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2024" }));
        ...
        TanggalDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2024 05:05:59" }));
        ...
        NoNIK.setName("NoNIK"); // NOI18N
        NoNIK.setPreferredSize(new java.awt.Dimension(250, 23));
        NoNIK.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoNIKKeyPressed(evt);
            }
        });
        panelGlass6.add(NoNIK);
    ...
    private void NoNIKKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoNIKKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            BtnCariActionPerformed(null);
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_UP){
            BtnKeluar.requestFocus();
        }
    }//GEN-LAST:event_NoNIKKeyPressed
    ...
    private void btnPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPasienKeyPressed
        Valid.pindah(evt,NoNIK,BtnPrint);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNo.getText().trim().equals("")){
            ...
            "where kamar_inap.stts_pulang='-' and pasien.no_rkm_medis=?",TNo.getText())>0){
             ...
             NoNIK.requestFocus();
        }else if(NoNIK.getText().trim().equals("")){
            Valid.textKosong(NoNIK, "Nomor Kartu");
        }else{            
            insertPasien();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekNIK dialog = new PCareCekNIK(new javax.swing.JFrame(), true);
    ...
    public void tampil(String nomorpeserta) {
	    ...
	    requestEntity = new HttpEntity(headers);
            ...
            root = mapper.readTree(api.getRest().exchange(link+"/peserta/nik/"+nomorpeserta, HttpMethod.GET, requestEntity, String.class).getBody());
	    ...
	    headers.add("X-signature",api.getHmac());
            ...
            if(nameNode.path("code").asText().equals("201")){
                ...
                if(Sequel.menyimpantf("pcare_pendaftaran","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'Terkirim'","No.Urut",20,new String[]{
                    ...
                    NoNIK.getText(),KdPoliTujuan.getText(),NmPoliTujuan.getText(),Keluhan.getText(),JenisKunjungan.getSelectedItem().toString(),
