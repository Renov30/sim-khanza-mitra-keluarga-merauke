...
//            ADDANTRIANAPIMOBILEJKNFKTP=koneksiDB.ADDANTRIANAPIMOBILEJKNFKTP();
    ...
    private void initComponents() {
        ...
        tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024 20:25:55" }));
        ...
        TanggalDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
        ...
        TanggalEstRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
        ...
        DTPCari5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
        ...
        DTPCari6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-11-2024" }));
                        ...
                        while(rscari.next()){
                            if(Sequel.cariInteger("select count(kode_brng) from pcare_obat_diberikan where tgl_perawatan='"+rscari.getString("tgl_perawatan")+"' and jam='"+rscari.getString("jam")+"' and no_rawat='"+tbKunjungan.getValueAt(i,0).toString()+"' and kode_brng='"+rscari.getString("kode_brng")+"'")==0){
                                ...
                                try {
                                    ...
                                    System.out.println(requestJson);
                                    requestEntity = new HttpEntity(requestJson,headers);
                                    requestJson=api.getRest().exchange(koneksiDB.URLAPIPCARE()+"/obat/kunjungan/V1", HttpMethod.POST, requestEntity, String.class).getBody();
                                    System.out.println(requestJson);
                                    root = mapper.readTree(requestJson);
                                    nameNode = root.path("metaData");
                                    System.out.println("code : "+nameNode.path("code").asText());
    ...
    */
    ...
    public void tampil() {        
        ...
        try {
            ps=koneksi.prepareStatement(
                ...
                "pcare_pendaftaran.kdTkp like ? or pcare_pendaftaran.keluhan like ? or pcare_pendaftaran.noUrut like ?) order by pcare_pendaftaran.tglDaftar");
            try {
    ...
    public void bodyWithDeleteRequest3() throws Exception {
        ...
        try {
            ...
            headers.add("X-authorization","Basic "+Base64.encodeBase64String(otorisasi.getBytes()));
            headers.add("user_key",koneksiDB.USERKEYAPIPCARE());
            root = mapper.readTree(restTemplate.exchange(koneksiDB.URLAPIPCARE()+"/kunjungan/V1/"+tbKunjungan.getValueAt(tbKunjungan.getSelectedRow(),1).toString(), HttpMethod.DELETE,new HttpEntity<String>(requestJson,headers), String.class).getBody());
            nameNode = root.path("metaData");
            System.out.println("code : "+nameNode.path("code").asText());
            System.out.println("message : "+nameNode.path("message").asText());
            if(nameNode.path("code").asText().equals("200")){
    ...
    public void bodyWithDeleteRequest4() throws Exception {
        ...
        try {
            ...
            headers.add("X-authorization","Basic "+Base64.encodeBase64String(otorisasi.getBytes()));
            headers.add("user_key",koneksiDB.USERKEYAPIPCARE());
            root = mapper.readTree(restTemplate.exchange(koneksiDB.URLAPIPCARE()+"/kunjungan/V1/"+tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),1).toString(), HttpMethod.DELETE,new HttpEntity<String>(requestJson,headers), String.class).getBody());
            nameNode = root.path("metaData");
            System.out.println("code : "+nameNode.path("code").asText());
            System.out.println("message : "+nameNode.path("message").asText());
            if(nameNode.path("code").asText().equals("200")){
